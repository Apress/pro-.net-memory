...
namespace CoreCLR.UnsafeTests
{
    ...
    public static class PassingByref
    {
        ...
        public static void ByRefInterior(ref int data)
        {
            ...
            data = 11;
            //Uncomment to make fully interruptible.
    ...
    class Constraints
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        // Listing 13-87
        unsafe public int UseUnmanagedConstraint<T>(T arg) where T : unmanaged
        {
            T* p = &arg;    // Use T* pointer
    ...
    public struct WeirdStruct
    {
        ...
        {
            var handle = GCHandle.Alloc(obj as object, GCHandleType.Pinned); // throws System.ArgumentException: Object contains non-primitive or non-blittable data.
            // ...
            return 0;
        }
    }
